...
export const ExplorationActivity = {
	...
	defend: {
		label: 'Defend',
		bonus:
			'Gain the benefits of Raising a Shield before your first turn begins',
		skill: 'Perception',
	},
	scout: {
		label: 'Scout',
	...
	track: {
		label: 'Track',
		bonus:
			'Free Seek action (using Survival) for hidden things in the immediate area at the start of an encounter',
		skill: 'Survival',
	},
	coverTracks: {
		label: 'Cover Tracks',
	...
	search: {
		label: 'Search',
		bonus:
			'Free Seek action (using Perception) for hidden things in the immediate area at the start of an encounter',
		skill: 'Perception',
	},
	repeatASpell: {
	...
	pursueALead: {
		...
		bonus:
			'You gain an Investigation circumstance bonus to initiative and other skill checks related to the lead',
		skill: 'Perception',
	},
	coerce: {
		label: 'Coerce',
...
export class PartyConfiguration {
	...
	get partyLevel(): LevelRange {
		return LevelRange.fromLevels(
			this.party.map((character) => character.level)
		);
	}
