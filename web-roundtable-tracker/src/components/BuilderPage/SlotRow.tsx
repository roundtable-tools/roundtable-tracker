	...
	return (
		<div className="border rounded-md bg-card p-3 space-y-3">
			<div className="w-full gap-2">
				{(() => {
					const slotTypeData = SLOT_TYPES.find(
			...
			<SlotRowParticipantContent
				...
				onRemoveReinforcementParticipant={handleRemoveReinforcementParticipant}
				...
				onReinforcementParticipantChange={handleReinforcementParticipantChange}
